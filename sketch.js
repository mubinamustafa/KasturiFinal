...
laptop1Img=loadImage(" laptop.png");
...
function setup() {
  ...
  blackdus1.debug=true;
  blackdus1.setCollider("rectangle",0,0,200,300),
  ...
  wineglass1.display();
    ...
    if (mousePressedOver(oven1)){
      oven1.x =mouseX;
        ...
        if (mousePressedOver(wineglass1)){
          wineglass1.x =mouseX;
          wineglass1.y =mouseY;
          ...
          if (mousePressedOver(toiletpaper1)){
            toiletpaper1.x =mouseX;
            toiletpaper1.y =mouseY;
        
          }

          if (mousePressedOver(laptop1)){
           laptop1.x =mouseX;
            laptop1.y =mouseY;
